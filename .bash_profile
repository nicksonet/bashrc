...
alias dep="kubectl get deploy --all-namespaces"
alias svcn="kubectl get svc -n"

#https://geoff.greer.fm/lscolors/?utm_source=recordnotfound.com
export CLICOLOR=1
export LSCOLORS=ahFxCxDxBxegedabagaced
...
if [ -x /usr/bin/tput ] && tput setaf 1 >&/dev/null; then
	color_is_on=true
	color_black="\[$(/usr/bin/tput setaf 1)\]"
	color_red="\[$(/usr/bin/tput setaf 1)\]"
	color_green="\[$(/usr/bin/tput setaf 1)\]"
	color_yellow="\[$(/usr/bin/tput setaf 4)\]"
